...
Check if `~/.claude/global-perspectives-news-prefs.json` exists.
...
Saves to `~/.claude/global-perspectives-news-prefs.json`.
...
- `company-research` — Deeper dives into specific companies
- `pestel-analysis` — Contextualize macro news into strategic implications
